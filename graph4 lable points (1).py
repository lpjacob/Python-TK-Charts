...
class Graph(Canvas):
	...
	def addPoint(self, x, y, txtVal):
		self.create_line(x+1.5, y-1.5, x-1.5, y+1.5, tags='all', fill=self.point_color)
		self.create_text(x+60,y, font=("Comic Sans MS",8), text=txtVal,fill=self.axis_color)
...
xValue = 200
yValue = 150
textVal = "Mr Jacob (%s,%s)"%(xValue,yValue)
